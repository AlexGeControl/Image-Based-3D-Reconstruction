...
void load_data(
    ...
    //
    {
        ...
        for (int i = 0; i < cameras.size(); i++) {
            ...
            stream >> cameras.at(i).focal_length;
            stream >> cameras.at(i).distortion[0] >> cameras.at(i).distortion[1];
            
            for (int j = 0; j < 3; j++) stream >> cameras.at(i).translation[j];
            
            for (int j = 0; j < 9; j++) stream >> cameras.at(i).rotation[j];
        }
    }

    //
    // b. load landmark positions:
    //
    {
        int n_points  = 0;
        getline(in, line);
        ...
        for(int i=0; i<n_points; i++) {
            ...
            stream >> points.at(i).pos[0] >> points.at(i).pos[1] >>points.at(i).pos[2];
        }
    }

    //
    // c. load landmark observations:
    //
    {
        ...
        for(int i=0; i<observations.size(); i++){
            ...
            stream>>observations.at(i).camera_id
                  >>observations.at(i).point_id
                  >>observations.at(i).pos[0]
                  >>observations.at(i).pos[1];
        }
    }
